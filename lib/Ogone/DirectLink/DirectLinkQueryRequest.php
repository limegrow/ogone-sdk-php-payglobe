...
class DirectLinkQueryRequest extends AbstractDirectLinkRequest
{
    ...
    const TEST = "https://test-securepay.eupayglobe.com/ncol/test/querydirect_utf8.asp";
    const PRODUCTION = "https://securepay.eupayglobe.com/ncol/prod/querydirect_utf8.asp";
