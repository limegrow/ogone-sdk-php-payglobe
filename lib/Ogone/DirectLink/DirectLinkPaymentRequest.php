...
class DirectLinkPaymentRequest extends AbstractPaymentRequest
{
    ...
    const TEST = "https://test-securepay.eupayglobe.com/ncol/test/orderdirect_utf8.asp";
    const PRODUCTION = "https://securepay.eupayglobe.com/ncol/prod/orderdirect_utf8.asp";
