...
class DirectLinkMaintenanceRequest extends AbstractDirectLinkRequest
{
    ...
    const TEST = "https://test-securepay.eupayglobe.com/ncol/test/maintenancedirect_utf8.asp";
    const PRODUCTION = "https://securepay.eupayglobe.com/ncol/prod/maintenancedirect_utf8.asp";
